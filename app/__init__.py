...
def create_app(config_filename):
    ...
    app.add_template_global(name="TAG_SOURCE",
                            f=["건국신화", "고대가요", "설화", "향가", "4구체", "8구체", "한시", "전", "소악부", "시조", "한시", "고려속요", "가전체",
                               "한문소설", "악장", "경기체가",
                               "가사", "몽유록", "고대", "중세", "근대", "사대부", "국문", "사설시조", "국문소설", "야담", "구비문학", "신소설", "근대소설",
                               "잡가", "사실주의", "계급주의", "낭만주의", "서사시", "모더니즘", "농촌소설", "역사소설", "순수소설", "순수시", "생명파",
                               "전원파", "민요", "창가", "신체시", "자유시", "저항시", "청록파", "일제강점기", "전후소설", "사실주의", "참여시", "민중시", "포스트모더니즘"
                               "반어법", "역설법", "수미상관"
